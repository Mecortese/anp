...
export class TechnicalAnalyzer {
  ...
  static calculateMACD(closes: number[]): { value: number; signal: number; histogram: number } {
  ...
  static calculateBollingerBands(closes: number[], period = 20, stdDev = 2): { upper: number; middle: number; lower: number } {
  ...
  static calculateATR(klines: Kline[], period = 14): number {
